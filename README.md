...
actions => Are events that we define that happen which lead to the next state.
reducers => It provides us with the previous states along with the enxt state.
store => It contains the state for our app.



- [ ] What is the difference between Application state and Component state? When would be a good time to use one over the other?

Application State is immutable while component state is mutable. 


- [ ] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

Redux Thunk is a middleware created by Dan Abramov, that provides the ability to handle asynchronous operations inside our Action Creators. It changes our action-creators as now we can make API calls from our action creators.


- [ ] What is your favorite state management system you've learned and this sprint? Please explain why!

  Redux, it is the easiest to use and feels like it has the most functionality. 
